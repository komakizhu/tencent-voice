...
application_path="/Applications/TencentVoiceMVP.app"
built_app="${project_root}/dist/TencentVoiceMVP.app"

case "${application_path}" in
  /Applications/TencentVoiceMVP.app) ;;
  *)
...
case "${built_app}" in
  "${project_root}/dist/TencentVoiceMVP.app") ;;
  *)
